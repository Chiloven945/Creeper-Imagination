...
execute at @s positioned ^ ^ ^0.6 run tp @s ~ ~ ~
...
execute positioned as @s positioned ~ ~-2 ~ run tag @e[distance=..0.5,type=!marker] add job_4_2_matched
execute positioned as @s positioned ~ ~-1.75 ~ run tag @e[distance=..0.5,type=!marker] add job_4_2_matched
execute positioned as @s positioned ~ ~-1.5 ~ run tag @e[distance=..0.5,type=!marker] add job_4_2_matched
execute positioned as @s positioned ~ ~-1.25 ~ run tag @e[distance=..0.5,type=!marker] add job_4_2_matched
execute positioned as @s positioned ~ ~-1 ~ run tag @e[distance=..0.5,type=!marker] add job_4_2_matched
execute positioned as @s positioned ~ ~-0.75 ~ run tag @e[distance=..0.5,type=!marker] add job_4_2_matched
execute positioned as @s positioned ~ ~-0.5 ~ run tag @e[distance=..0.5,type=!marker] add job_4_2_matched
execute positioned as @s positioned ~ ~-0.25 ~ run tag @e[distance=..0.5,type=!marker] add job_4_2_matched
