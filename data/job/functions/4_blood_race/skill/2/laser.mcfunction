...
scoreboard players set @e[tag=job_4_2_marker_new] job_4_2_marker_life 21
execute at @s run playsound minecraft:entity.firework_rocket.blast player @a[distance=..15] ~ ~ ~ 100 1.7
