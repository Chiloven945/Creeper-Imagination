...
execute at @s[tag=!job_5_3_pass] run playsound minecraft:block.note_block.didgeridoo player @s ~ ~ ~ 100 1
...
execute at @s[tag=job_5_3_pass] run playsound minecraft:entity.allay.death player @a[distance=..15] ~ ~ ~ 100 0
...
execute as @a[tag=job_5_3_target] at @s run playsound minecraft:entity.elder_guardian.curse player @s ~ ~ ~ 100 1
