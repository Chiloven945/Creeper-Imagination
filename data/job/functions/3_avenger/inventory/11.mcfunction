...
item replace entity @s[scores={HP=11..}] armor.head with sculk_sensor[item_name='{"text": "面具","color": "white","italic": false}',lore=['{"text": "✎ 压制着怒火","color": "gray","italic": false}']] 1
...
item replace entity @s[scores={HP=..10}] armor.head with calibrated_sculk_sensor[item_name='{"text": "复仇面具","color": "white","italic": false}',lore=['{"text": "✎ 不灭......","color": "gray","italic": false}']] 1