...
execute as @s at @s anchored eyes positioned ^ ^ ^-1 run summon arrow ~ ~ ~ {Tags:["job_2_1_new","job_2_1"],ShotFromCrossbow:1b,LeftOwner:1b,shake:0b,crit:0b,pickup:0b,damage:1.0,SoundEvent:"minecraft:entity.player.attack.crit"}
