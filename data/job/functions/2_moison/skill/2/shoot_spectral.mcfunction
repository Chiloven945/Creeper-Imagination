...
execute as @s at @s anchored eyes positioned ^ ^ ^-1 run summon spectral_arrow ~ ~ ~ {Tags:["job_2_2_new","job_2_2"],damage:0.6d,SoundEvent:"minecraft:entity.player.attack.crit"}
...
execute as @s at @s anchored eyes positioned ^-1 ^ ^-1 run summon spectral_arrow ~ ~ ~ {Tags:["job_2_2_new","job_2_2"],damage:0.6d,SoundEvent:"minecraft:entity.player.attack.crit"}
execute at @e[tag=job_2_2_new] run tp @e[tag=job_2_2_new] ~ ~ ~ facing entity @s
