...
clear @s birch_button[item_name='{"text": "即将冷却完毕","color": "white","italic": false}',lore=['{"text": "9-技能","color": "gray","italic": false}']]
...
$item replace entity @s hotbar.8 with birch_button[item_name='{"text": "即将冷却完毕","color": "white","italic": false}',lore=['{"text": "9-技能","color": "gray","italic": false}']] $(cd_9_t)