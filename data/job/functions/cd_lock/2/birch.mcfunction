...
clear @s birch_button[item_name='{"text": "即将冷却完毕","color": "white","italic": false}',lore=['{"text": "2-技能","color": "gray","italic": false}']]
...
$item replace entity @s hotbar.1 with birch_button[item_name='{"text": "即将冷却完毕","color": "white","italic": false}',lore=['{"text": "2-技能","color": "gray","italic": false}']] $(cd_2_t)