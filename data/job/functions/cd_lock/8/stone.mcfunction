...
clear @s stone_button[item_name='{"text": "冷却中","color": "white","italic": false}',lore=['{"text": "8-技能","color": "gray","italic": false}']]
...
$item replace entity @s hotbar.7 with stone_button[item_name='{"text": "冷却中","color": "white","italic": false}',lore=['{"text": "8-技能","color": "gray","italic": false}']] $(cd_8)