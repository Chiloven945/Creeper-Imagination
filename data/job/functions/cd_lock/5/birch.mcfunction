...
clear @s birch_button[item_name='{"text": "即将冷却完毕","color": "white","italic": false}',lore=['{"text": "5-技能","color": "gray","italic": false}']]
...
$item replace entity @s hotbar.4 with birch_button[item_name='{"text": "即将冷却完毕","color": "white","italic": false}',lore=['{"text": "5-技能","color": "gray","italic": false}']] $(cd_5_t)