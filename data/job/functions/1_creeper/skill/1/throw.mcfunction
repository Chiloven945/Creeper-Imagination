execute as @s at @s anchored eyes run summon creeper ~ ~0.9 ~ {Tags:["job_1_1_new","job_1_1"],ExplosionRadius:2b,Attributes:[ { Base:20000, Name:"minecraft:generic.max_health"}], Fuse:25,ignited:1b}
effect give @e[tag=job_1_1_new] instant_health 1 200 true
execute at @s run playsound minecraft:entity.firework_rocket.blast_far player @a[distance=..15] ~ ~ ~ 100 2
