...
tag @a[scores={job=3},nbt={Inventory: [{Slot: -106b, id: "minecraft:chest"}]}] add 3_skill_3_start
    scoreboard players set @a[scores={job=3},nbt={Inventory: [{Slot: -106b, id: "minecraft:chest"}]}] cd_3 150
...
#循环
schedule function ci:loop/game/job/3/skill/3 1t append
