...
execute if score $tool mode matches 1 run scoreboard players set @s choose_job_page -1
execute if score $tool mode matches 1 if score $tool game_stage matches 2 run bossbar set ci:choose_job players @a
...
execute if score $tool mode matches 0 run scoreboard players set @s choose_job_page 1

execute unless score $tool game_stage matches 2 run bossbar set ci:choose_job players