...
item replace entity @s[scores={steal_ready=0}] hotbar.0 with gray_dye[item_name='{"text": "未准备","color": "white","italic": false}',lore=['{"text": "✎ 游戏开始后会成为旁观者","color": "gray","italic": false}','[{"text": "❃ ","color": "gray","italic": false},{"text": "右键","color": "white","italic": false},{"text": "进行准备","color": "gray","italic": false}]']] 1

item replace entity @s[scores={steal_ready=1}] hotbar.0 with lime_dye[item_name='{"text": "已准备","color": "white","italic": false}',lore=['{"text": "✎ 游戏开始后会参与游戏","color": "gray","italic": false}','[{"text": "❃ ","color": "gray","italic": false},{"text": "右键","color": "white","italic": false},{"text": "取消准备","color": "gray","italic": false}]']] 1
