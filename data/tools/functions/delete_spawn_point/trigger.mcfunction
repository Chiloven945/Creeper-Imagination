...
execute if entity @e[distance=..2,tag=spawn_point] as @s at @s run playsound minecraft:entity.arrow.hit_player player @s ~ ~ ~ 100 1
execute unless entity @e[distance=..2,tag=spawn_point] as @s at @s run playsound minecraft:block.note_block.didgeridoo player @s ~ ~ ~ 100 1
